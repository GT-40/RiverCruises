...
namespace Курсовой_проект_ТРЗБД
{
    ...
    public partial class RiverCruisesEntities : DbContext
    {
        public RiverCruisesEntities()
            : base("name=RiverCruisesEntities")
        {
        }
        ...
        public virtual DbSet<SeatsInCabins> SeatsInCabins { get; set; }
